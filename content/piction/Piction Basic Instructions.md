...
For each of our art collection works there is  a "primary" image, and other images associated with that work are “detail” images. You can tell that detail images exist if there is a ![image alt text](image_5.png) icon under the image. 

Clicking on the D reveals one or more details (in this example there are 5 images total):  ![image alt text](image_6.png)
...
Searching for **1974.6** gives us the result at right: 
